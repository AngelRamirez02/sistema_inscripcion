 ...
 * @author ar275
 */
public class GruposDocenteCalif extends javax.swing.JFrame {
   ...
   ListasGrupos alumno;
    ...
    public GruposDocenteCalif(String rfc) throws SQLException {
        this.rfc = rfc;
    ...
    private void initComponents() {
        ...
        jPanel2.add(lb_nombreCoordinador, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 500, 40));
        ...
        jLabel1.setText("Seleccione el grupo a cargar calificaciones");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 40, 600, 40));

        btn_seleccionarMateria.setBackground(new java.awt.Color(0, 51, 255));
        btn_seleccionarMateria.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btn_seleccionarMateria.setForeground(new java.awt.Color(255, 255, 255));
        btn_seleccionarMateria.setText("Registrar calificaciones");
        ...
        jPanel2.add(btn_seleccionarMateria, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, 300, 60));
    ...
    private void btn_seleccionarMateriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_seleccionarMateriaActionPerformed
        ...
        if (fila != -1) {
            ...
            String id_materia="";
            try {
                id_materia = obtenerIdMateria(tabla_horarios.getValueAt(fila, 3).toString());
            } catch (SQLException ex) {
                Logger.getLogger(GruposDocenteCalif.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
                CargarCalificacion ventana = new CargarCalificacion(rfc, LocalDate.now(), LocalTime.now(), id_grupo, id_materia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposDocenteCalif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new GruposDocenteCalif(null).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(GruposDocenteCalif.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
